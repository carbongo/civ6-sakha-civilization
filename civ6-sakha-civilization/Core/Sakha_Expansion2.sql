...
VALUES 
    ('NAMED_RIVER_ULAKHAN', 'KIND_NAMED_RIVER'),
...
VALUES 
    ('NAMED_RIVER_ULAKHAN', 'LOC_NAMED_RIVER_ULAKHAN'),
...
INSERT OR REPLACE INTO NamedMountains (NamedMountainType, Name)
VALUES 
    ('NAMED_MOUNTAIN_KHARAULAKH', 'LOC_NAMED_MOUNTAIN_KHARAULAKH'),
    ('NAMED_MOUNTAIN_ORULGAN', 'LOC_NAMED_MOUNTAIN_ORULGAN');

INSERT OR REPLACE INTO NamedVolcanoes (NamedVolcanoType, Name)
VALUES 
    ('NAMED_VOLCANO_BALAGANTAS', 'LOC_NAMED_VOLCANO_BALAGANTAS');

INSERT OR REPLACE INTO NamedLakes (NamedLakeType, Name)
VALUES 
    ('NAMED_LAKE_SAISARY', 'LOC_NAMED_LAKE_SAISARY');

INSERT OR REPLACE INTO NamedSeas (NamedSeaType, Name)
VALUES 
    ('NAMED_SEA_KHARA', 'LOC_NAMED_SEA_KHARA'),
...
VALUES 
    ('NAMED_RIVER_ULAKHAN', 'CIVILIZATION_SAKHA_CIV_CUSTOM'),
...
VALUES 
    ('NAMED_MOUNTAIN_KHARAULAKH', 'CIVILIZATION_SAKHA_CIV_CUSTOM'),
...
VALUES 
    ('NAMED_VOLCANO_BALAGANTAS', 'CIVILIZATION_SAKHA_CIV_CUSTOM');

INSERT OR REPLACE INTO NamedLakeCivilizations (NamedLakeType, CivilizationType)
VALUES 
    ('NAMED_LAKE_SAISARY', 'CIVILIZATION_SAKHA_CIV_CUSTOM');
