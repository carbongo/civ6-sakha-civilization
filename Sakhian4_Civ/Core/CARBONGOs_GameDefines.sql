...
INSERT INTO TraitModifiers			
		(TraitType,											ModifierId)
VALUES  ('TRAIT_CIVILIZATION_CB_SAKHA_GRIND',					'CB_TRAIT_PASTURE_GOLD_BOOST'),
		('TRAIT_CIVILIZATION_CB_SAKHA_GRIND',					'CB_TRAIT_CAMP_FOOD_BOOST'),
		('TRAIT_CIVILIZATION_CB_SAKHA_GRIND',					'CB_TRAIT_FISHINGBOATS_GOLD_BOOST'),
...
VALUES	('CB_TRAIT_PASTURE_GOLD_BOOST',					'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',			'PLOT_HAS_PASTURE_REQUIREMENTS'),
		('CB_TRAIT_CAMP_FOOD_BOOST',					'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',			'PLOT_HAS_CAMP_REQUIREMENTS'),
		('CB_TRAIT_FISHINGBOATS_GOLD_BOOST',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',			'PLOT_HAS_FISHINGBOATS_REQUIREMENTS'),
...
INSERT INTO ModifierArguments
		(ModifierId,					Name,						Value)
VALUES  ('CB_TRAIT_PASTURE_GOLD_BOOST',					'YieldType',		'YIELD_GOLD'),
		('CB_TRAIT_PASTURE_GOLD_BOOST',					'Amount',			'1'),
		('CB_TRAIT_CAMP_FOOD_BOOST',					'YieldType',		'YIELD_FOOD'),
		('CB_TRAIT_CAMP_FOOD_BOOST',					'Amount',			'1'),
		('CB_TRAIT_FISHINGBOATS_GOLD_BOOST',			'YieldType',		'YIELD_GOLD'),
		('CB_TRAIT_FISHINGBOATS_GOLD_BOOST',			'Amount',			'1'),
